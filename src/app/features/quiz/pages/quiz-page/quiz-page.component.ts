...
import { Quiz, shuffle, QuizAnswer, Mark } from '../../models/quiz.model';
...
export class QuizPageComponent implements OnDestroy {
    ...
    ngOnInit() {
        ...
        this.remainTime =
            this.minutes - Number(startAt) >= 0
                ...
                : (this.time + Number(startAt) - (60 + this.minutes)) *
                  60 *
                  1000;
        this.timer = setInterval(() => {
            ...
            if (this.remainTime <= 0) {
                ...
                this.totalResult = this.currentQuizList.map((quiz, index) => {
                    ...
                    let score: any = isCorrect
                        ? this.totalAnswer[index]?.score
                        : 0;
                    return {
                        isCurrentChoose: {
                            ...this.totalAnswer[index],
                            score: score,
                        },
                        isCorrect,
                    };
                ...
                this.currentQuizList = this.currentQuizList.map(
                    (quiz, index) => {
                        return {
                            ...quiz,
                ...
                localStorage.setItem(
                    'result',
                    JSON.stringify(this.currentQuizList)
                );
    ...
    postMark() {
        ...
        this.quizService
            .postMark(this.studentId, result)
