...
import {
  AnnualLearningKindService,
  PercentageMark,
} from '../../data-access/annual-learning-kind.service';
import {
  ApexAxisChartSeries,
  ApexChart,
  ApexTitleSubtitle,
          ...
          this.series = [
            {
              name: 'My-series',
              data: [
                this.percentageMark.percentage_good,
                this.percentageMark.percentage_fairly,
                this.percentageMark.percentage_medium,
                this.percentageMark.percentage_bad,
              ],
            },
          ];
        }
