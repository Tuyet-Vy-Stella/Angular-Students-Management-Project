...
import { IClassElement, ITeacher } from '../utils/classroom';
import {
  BehaviorSubject,
  catchError,
  map,
          ...
          return this.teacherSearchList$.pipe(
            map((value) => {
              ...
              editTeachers.unshift({
                name: this.dataStorage.currentClass.form_teacher,
                id: this.dataStorage.currentClass.form_teacher_id,
              });
              this.teacherActiveOption$.next(
                '' + this.dataStorage.currentClass.form_teacher_id
              );
              return editTeachers;
            })
          );
